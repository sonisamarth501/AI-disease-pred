...
# Heading
w2 = Label(root, justify=LEFT, text="  Machine Learning Project", fg="black", bg="white")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="  On Disease Prediction", fg="black", bg="white")
...
#textfileds
t1 = Text(root, height=1, width=40,bg="grey",fg="black")
t1.grid(row=15, column=1, padx=10)

t2 = Text(root, height=1, width=40,bg="grey",fg="black")
t2.grid(row=17, column=1 , padx=10)

t3 = Text(root, height=1, width=40,bg="grey",fg="black")
